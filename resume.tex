  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.S./M.S. Computer Science, Minor in Mathematics. GPA 3.9/4.0.}{Aug. 2020 -- Dec 2024}
        \textit{\small{\item{
          \textbf{Computer Science Coursework}{: Operating Systems, Networks, Compilers, Cryptography, Machine Learning, Data Science, Algorithms/Data Structures} \\
          \textbf{Math Coursework: }{Abstract Algebra, Linear Algebra, Signal Processing, Number Theory, Cryptography}
        }}}
  ...
  \resumeSubHeadingListStart
    ...
    {Naval Research Laboratory}{Washington, D.C.}
      \resumeItemListStart
        ...
        \resumeItem{Hardened application with military-grade security; ensured
        ...
        \resumeItem{Renovated team's development pipeline; architectural
        advancements slashed prod build times by 25\% and dev build times by
        99.96\%. Created Docker/Python-powered build/deployment utility to
        replace manual RPM build/deploy workflow.}

        \resumeItem{Optimized communication between app/backend for
        easier inspection by developers; yielded 20\% shorter
        message bodies. Analyzed legacy TCP-based protocol with Wireshark;
        removed redundancies and redesigned atop HTTP + standard JSON.}

        \resumeItem{Avoided time/labor-intensive modification to incumbent C++
        backend; created $\sim$1000 LoC compatibility layer for new protocol.
        Implemented reverse proxy/server running alongside backend; leveraged
        Rust to minimize performance overhead.}

        \resumeItem{Ensured seamless software installation for nontechnical end
        users; reduced manual intervention necessary by 92\% in software
        installation process. Developed automatic and modern deployment system
